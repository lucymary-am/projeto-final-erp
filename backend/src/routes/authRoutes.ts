...
import { loginSchema, refreshSchema, logoutSchema, googleLoginSchema } from "../dtos/AuthDTO.js";
...
router.post("/google", validateBody(googleLoginSchema), authController.google.bind(authController));
